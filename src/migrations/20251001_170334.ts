...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  ALTER TABLE "challenges_tags" ADD CONSTRAINT "challenges_tags_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."challenges"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "challenges_tags_order_idx" ON "challenges_tags" USING btree ("_order");
  CREATE INDEX "challenges_tags_parent_id_idx" ON "challenges_tags" USING btree ("_parent_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "challenges_tags" CASCADE;
